/**
 * AI Battle Music System - Система конкурирующих нейросетей
 */
...
class AIBattleSystem {
    ...
    async init() {
        try {
            ...
            console.log('AI Battle System инициализирован');
        } catch (error) {
    ...
    getUserId() {
        // Получаем ID пользователя из Telegram Web App или используем дефолтный
        if (window.Telegram && window.Telegram.WebApp) {
            return window.Telegram.WebApp.initDataUnsafe?.user?.id || 1118235356;
        }
